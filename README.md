...
This package is a Laravel bridge to [Google2FA](https://github.com/irayoun/google2fa-laravel)'s PHP package.
...
Here's an demo app showing how to use Google2FA: [google2fa-example](https://github.com/irayoun/google2fa-example).
...
Use Composer to install it:
    ...
    composer require irayoun/google2fa-laravel
...
And you can use Authentication guards:
...
[Youness IRAGUI](http://twitter.com/yiragui)
